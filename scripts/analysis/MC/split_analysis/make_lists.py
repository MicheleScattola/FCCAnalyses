...
output_dir = "/afs/cern.ch/user/s/scattola/FCCAnalyses/scripts/analysis/MC/split_analysis/lists"
output_dir_root = "/eos/user/s/scattola/FCCAnalyses/Ztautau/treemaker/MC/split_analysis/"
