...
output_dir = "/afs/cern.ch/user/s/scattola/FCCAnalyses/scripts/analysis/RECO/segmented_analysis/lists"
output_dir_root = "/eos/user/s/scattola/FCCAnalyses/Ztautau/treemaker/RECO/segmented_analysis/"
