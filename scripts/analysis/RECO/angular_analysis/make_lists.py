...
output_dir = "/afs/cern.ch/user/s/scattola/FCCAnalyses/scripts/analysis/RECO/angular_analysis/lists"
output_dir_root = "/eos/user/s/scattola/FCCAnalyses/Ztautau/treemaker/RECO/angular_analysis/"
