...
class RDFanalysis():
  ...
  "ReconstructedParticle2MC::getRP2MC_index(MCRecoAssociations0, MCRecoAssociations1, rps)")
				...
				# pi binned weights (10 bins from -0.95 to 0.95 at step 0.19)
				.Define("w_plus_pi_bin0","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,-0.95,-0.76)")
				.Define("w_plus_pi_bin1","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,-0.76,-0.57)")
				.Define("w_plus_pi_bin2","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,-0.57,-0.38)")
				.Define("w_plus_pi_bin3","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,-0.38,-0.19)")
				.Define("w_plus_pi_bin4","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,-0.19,0.00)")
				.Define("w_plus_pi_bin5","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,0.00,0.19)")
				.Define("w_plus_pi_bin6","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,0.19,0.38)")
				.Define("w_plus_pi_bin7","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,0.38,0.57)")
				.Define("w_plus_pi_bin8","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,0.57,0.76)")
				.Define("w_plus_pi_bin9","Ztautau::get_weights_theta(1,myEvent,3,false,3,true,0.76,0.95)")
				.Define("w_minus_pi_bin0","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,-0.95,-0.76)")
				.Define("w_minus_pi_bin1","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,-0.76,-0.57)")
				.Define("w_minus_pi_bin2","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,-0.57,-0.38)")
				.Define("w_minus_pi_bin3","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,-0.38,-0.19)")
				.Define("w_minus_pi_bin4","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,-0.19,0.00)")
				.Define("w_minus_pi_bin5","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,0.00,0.19)")
				.Define("w_minus_pi_bin6","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,0.19,0.38)")
				.Define("w_minus_pi_bin7","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,0.38,0.57)")
				.Define("w_minus_pi_bin8","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,0.57,0.76)")
				.Define("w_minus_pi_bin9","Ztautau::get_weights_theta(-1,myEvent,3,false,3,true,0.76,0.95)")

				# rho binned weights
				.Define("w_plus_rho_bin0","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,-0.95,-0.76)")
				.Define("w_plus_rho_bin1","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,-0.76,-0.57)")
				.Define("w_plus_rho_bin2","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,-0.57,-0.38)")
				.Define("w_plus_rho_bin3","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,-0.38,-0.19)")
				.Define("w_plus_rho_bin4","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,-0.19,0.00)")
				.Define("w_plus_rho_bin5","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,0.00,0.19)")
				.Define("w_plus_rho_bin6","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,0.19,0.38)")
				.Define("w_plus_rho_bin7","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,0.38,0.57)")
				.Define("w_plus_rho_bin8","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,0.57,0.76)")
				.Define("w_plus_rho_bin9","Ztautau::get_weights_theta(1,myEvent,4,false,4,true,0.76,0.95)")
				.Define("w_minus_rho_bin0","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,-0.95,-0.76)")
				.Define("w_minus_rho_bin1","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,-0.76,-0.57)")
				.Define("w_minus_rho_bin2","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,-0.57,-0.38)")
				.Define("w_minus_rho_bin3","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,-0.38,-0.19)")
				.Define("w_minus_rho_bin4","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,-0.19,0.00)")
				.Define("w_minus_rho_bin5","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,0.00,0.19)")
				.Define("w_minus_rho_bin6","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,0.19,0.38)")
				.Define("w_minus_rho_bin7","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,0.38,0.57)")
				.Define("w_minus_rho_bin8","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,0.57,0.76)")
				.Define("w_minus_rho_bin9","Ztautau::get_weights_theta(-1,myEvent,4,false,4,true,0.76,0.95)")
            

				# el binned weights
				.Define("w_plus_el_bin0","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,-0.95,-0.76)")
				.Define("w_plus_el_bin1","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,-0.76,-0.57)")
				.Define("w_plus_el_bin2","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,-0.57,-0.38)")
				.Define("w_plus_el_bin3","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,-0.38,-0.19)")
				.Define("w_plus_el_bin4","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,-0.19,0.00)")
				.Define("w_plus_el_bin5","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,0.00,0.19)")
				.Define("w_plus_el_bin6","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,0.19,0.38)")
				.Define("w_plus_el_bin7","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,0.38,0.57)")
				.Define("w_plus_el_bin8","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,0.57,0.76)")
				.Define("w_plus_el_bin9","Ztautau::get_weights_theta(1,myEvent,2,false,2,true,0.76,0.95)")
				.Define("w_minus_el_bin0","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,-0.95,-0.76)")
				.Define("w_minus_el_bin1","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,-0.76,-0.57)")
				.Define("w_minus_el_bin2","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,-0.57,-0.38)")
				.Define("w_minus_el_bin3","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,-0.38,-0.19)")
				.Define("w_minus_el_bin4","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,-0.19,0.00)")
				.Define("w_minus_el_bin5","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,0.00,0.19)")
				.Define("w_minus_el_bin6","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,0.19,0.38)")
				.Define("w_minus_el_bin7","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,0.38,0.57)")
				.Define("w_minus_el_bin8","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,0.57,0.76)")
				.Define("w_minus_el_bin9","Ztautau::get_weights_theta(-1,myEvent,2,false,2,true,0.76,0.95)")

				# mu binned weights
				.Define("w_plus_mu_bin0","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,-0.95,-0.76)")
				.Define("w_plus_mu_bin1","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,-0.76,-0.57)")
				.Define("w_plus_mu_bin2","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,-0.57,-0.38)")
				.Define("w_plus_mu_bin3","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,-0.38,-0.19)")
				.Define("w_plus_mu_bin4","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,-0.19,0.00)")
				.Define("w_plus_mu_bin5","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,0.00,0.19)")
				.Define("w_plus_mu_bin6","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,0.19,0.38)")
				.Define("w_plus_mu_bin7","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,0.38,0.57)")
				.Define("w_plus_mu_bin8","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,0.57,0.76)")
				.Define("w_plus_mu_bin9","Ztautau::get_weights_theta(1,myEvent,1,false,1,true,0.76,0.95)")
				.Define("w_minus_mu_bin0","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,-0.95,-0.76)")
				.Define("w_minus_mu_bin1","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,-0.76,-0.57)")
				.Define("w_minus_mu_bin2","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,-0.57,-0.38)")
				.Define("w_minus_mu_bin3","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,-0.38,-0.19)")
				.Define("w_minus_mu_bin4","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,-0.19,0.00)")
				.Define("w_minus_mu_bin5","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,0.00,0.19)")
				.Define("w_minus_mu_bin6","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,0.19,0.38)")
				.Define("w_minus_mu_bin7","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,0.38,0.57)")
				.Define("w_minus_mu_bin8","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,0.57,0.76)")
				.Define("w_minus_mu_bin9","Ztautau::get_weights_theta(-1,myEvent,1,false,1,true,0.76,0.95)")
