...
void fitALL() {
    ...
    // 1. CONFIGURATION
    // =========================================================================
    const std::string infile_data = "/afs/cern.ch/user/s/scattola/FCCAnalyses/Ztautau/treemaker/RECO/p8_ee_Ztautau_ecm91.root";
    const std::string infile_templates = "/afs/cern.ch/user/s/scattola/FCCAnalyses/Ztautau/treemaker/RECO/templates/templates.root";
