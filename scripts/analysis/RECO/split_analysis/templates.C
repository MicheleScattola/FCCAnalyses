...
void templates() {
    ...
    // Settings
    const char* infile = "/eos/user/s/scattola/FCCAnalyses/Ztautau/treemaker/RECO/split_analysis/templates_merged.root";
    const char* outdir = "/afs/cern.ch/user/s/scattola/FCCAnalyses/Ztautau/plots/RECO/split_analysis/";
    const char* outdir2 = "/eos/user/s/scattola/FCCAnalyses/Ztautau/treemaker/RECO/split_analysis/";
