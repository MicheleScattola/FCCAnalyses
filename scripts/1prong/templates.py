...
#output directory
outputDir = "/afs/cern.ch/user/s/scattola/FCCAnalyses/Ztautau/treemaker/templates/"
...
class RDFanalysis():
  ...
  "ReconstructedParticle2MC::getRP2MC_index(MCRecoAssociations0, MCRecoAssociations1, rps)")
				...
				.Define("w_plus_pi","Ztautau::get_weights(1,myEvent,3,false,3,true,true,true)")
				.Define("w_minus_pi","Ztautau::get_weights(-1,myEvent,3,false,3,true,true,true)")
                ...
                .Define("w_plus_el","Ztautau::get_weights(1,myEvent,2,false,2,true,true,true)")
				.Define("w_minus_el","Ztautau::get_weights(-1,myEvent,2,false,2,true,true,true)")
                .Define("w_plus_mu","Ztautau::get_weights(1,myEvent,1,false,1,true,true,true)")
				.Define("w_minus_mu","Ztautau::get_weights(-1,myEvent,1,false,1,true,true,true)")
