...
#output directory
outputDir = "/afs/cern.ch/user/s/scattola/FCCAnalyses/Ztautau/treemaker/MC/"
...
class RDFanalysis():
  ...
  "ReconstructedParticle2MC::getRP2MC_index(MCRecoAssociations0, MCRecoAssociations1, rps)")
				...
				.Define("pi_sgn","Ztautau::get_hadron_e(myEvent,3,false,3,true,true,false)")
                ...
                .Define("el_sgn","Ztautau::get_lepton_e(myEvent,2,false,2,true,true,false)")
                ...
                .Define("mu_sgn","Ztautau::get_lepton_e(myEvent,1,false,1,true,true,false)")
