...
class RDFanalysis():
  ...
  "ReconstructedParticle2MC::getRP2MC_index(MCRecoAssociations0, MCRecoAssociations1, rps)")
				...
				.Define("pi_sgn","Ztautau::get_hadron_e(myEvent,3,true,3,false,false,false)")
                ...
                .Define("el_sgn","Ztautau::get_lepton_e(myEvent,2,true,2,false,false,false)")
                .Define("w_plus_el","Ztautau::get_weights(1,myEvent,2,true,2,false,false,false)")
                .Define("w_minus_el","Ztautau::get_weights(-1,myEvent,2,true,2,true,true,false)")
                .Define("mu_sgn","Ztautau::get_lepton_e(myEvent,1,true,1,true,true,false)")
