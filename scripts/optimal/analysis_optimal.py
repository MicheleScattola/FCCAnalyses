...
class RDFanalysis():
  ...
  "ReconstructedParticle2MC::getRP2MC_index(MCRecoAssociations0, MCRecoAssociations1, rps)")
				...
				.Define("myPDG","Ztautau::truth_pdg(myPi)")
				
				
				
				# 1 prong BACKGROUND VALUES
				.Define("pi_bkg","Ztautau::confusion_e(myPi,-3,true,3,true,111,false,0)/45.5")
				
				# 1 prong SIGNAL VALUES
				.Define("mu_sgn","Ztautau::true_e(myMu,1,false,1,true,11,false,0)/45.5")
				.Define("el_sgn","Ztautau::true_e(myEl,2,false,2,true,13,false,0)/45.5")
